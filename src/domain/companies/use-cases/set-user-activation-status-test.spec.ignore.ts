...
import { SetUserActivationStatusUseCase } from './set-user-activation-status-use-case'

let inMemoryUsersRepository: InMemoryUsersRepository
let sut: SetUserActivationStatusContract

describe('Set User Activation Status Test', () => {
  beforeEach(() => {
